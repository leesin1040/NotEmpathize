  ...
  html = `
    <div class="detail-container">
      <div class="detail-back">
        <button type="button" class="btn btn-secondary" id="backward">
          <a href="/">뒤로 가기</a>
        </button>
      </div>
      <div class="content">
        ...
        <div class="info">
          ...
          <div class="desc">
            ...
            <p class="actor">출연 배우: ${credits.cast[0].original_name}, ${
    credits.cast[1].original_name
  }, ${credits.cast[2].original_name}</p>
...
const commentDraw = (movieId) => {
  ...
  if (comments.length === 0)
    document.querySelector('.comment-content').innerHTML = nonReview;
  else
    document.querySelector('.comment-content').innerHTML = commentHTML.join('');
...
const deleteComment = (btn) => {
  btn.addEventListener('click', (event) => {
    ...
    const deleteIndex =
      event.currentTarget.parentElement.parentElement.getAttribute(
        'data-index'
      );
